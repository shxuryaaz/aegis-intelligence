      ...
      <main>
            ...
            <div className="grid gap-8 py-20 md:py-28 lg:grid-cols-2 items-center">
              ...
              >
                ...
                <p className="mt-4 text-muted-foreground text-lg max-w-xl">
                  An enterprise-grade platform for regulators and investors to
                  identify scams, deepfakes, fake advisors, and market
                  ...
                  <div className="p-6 grid gap-4 h-full">
                    <div className="grid grid-cols-4 gap-3">
                      {[42, 7, 18, 12].map((v, i) => (
                        <div
                          key={i}
                          className="rounded-md border border-border/60 bg-background/60 p-3 text-center"
                        >
        ...
        <Section id="solutions" className="py-12">
          ...
          >
            <div className="text-sm text-primary/80">
              Trusted by financial institutions, built for regulators.
            </div>
            <p className="mt-2 text-sm text-muted-foreground">
              Our technology is aligned with SEBI’s Safe Space initiative and
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
              {Array.from({ length: 6 }).map((_, i) => (
                <div
                  key={i}
                  className="h-10 rounded bg-muted/30 border border-border/60"
                />
              ))}
            </div>
          </motion.div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="grid gap-6">
              {[
                {
                  icon: BadgeCheck,
                  title: "Advisor & IPO Verification",
                  text: "Verify advisors by name/phone/email and IPOs by company/ISIN with registry-backed confidence.",
                },
                {
                  icon: FileSearch,
                  title: "Fraudulent Content Detection",
                  text: "Scan text, PDFs, audio, and video for deepfakes, scams, and manipulation.",
                },
                {
                  icon: Gauge,
                  title: "Pump-and-Dump Monitoring",
                  text: "Detect abnormal volumes and coordinated behavior across sources.",
                },
                {
                  icon: Workflow,
                  title: "Case Management & Dashboard",
                  text: "Escalate alerts, assign cases, and track timelines across teams.",
                },
              ].map((f) => (
                <motion.div
                  key={f.title}
                ...
                >
                  <div className="mt-1 rounded-md border border-border/60 bg-secondary/30 p-2 text-primary">
            ...
            >
              <Card className="h-[420px] bg-card/40 border-border/60 border relative">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(120deg, rgba(56,189,248,0.05), rgba(34,197,94,0.05))",
                  }}
                />
                <div className="p-6 grid gap-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div
                        key={i}
                        className="h-20 rounded bg-background/60 border border-border/60"
                      />
                    ))}
                  </div>
        ...
        <Section id="company" className="py-16">
          <h2 className="text-2xl font-semibold text-center mb-10">
            Enterprise-Ready. Regulator-Proven.
          </h2>
          <div className="grid gap-6 md:grid-cols-3">
            {[
              {
                title: "Compliance-first architecture",
                text: "Data residency, audit trails, and policy controls aligned to enterprise standards.",
              },
              {
                title: "Scalable infrastructure",
                text: "Built on modern cloud primitives with isolation and reliability SLAs.",
              },
              {
                title: "Explainable AI scoring",
                text: "Transparent rationales, confidence metrics, and governance hooks.",
              },
            ].map((v) => (
        ...
        <Section id="contact" className="py-20 text-center">
          <div className="mx-auto max-w-3xl">
            <h3 className="text-2xl font-semibold">
              Safeguard investors. Strengthen trust. Ensure compliance.
            </h3>
            <p className="text-muted-foreground mt-2">
              Request early access to Aegis Intelligence.
            </p>
            <div className="mt-6 flex justify-center gap-3">
              <Button asChild>
                <Link to="/auth">Request Early Access</Link>
              </Button>
              <Button variant="outline" asChild>
      ...
      <footer className="border-t border-border/60">
        <Section className="py-12">
          <div className="grid gap-8 md:grid-cols-4 text-sm">
            <div>
              ...
              <ul className="mt-3 space-y-2 text-muted-foreground">
                <li>
                  <a href="#platform">Advisor Verification</a>
                </li>
                <li>
                  <a href="#platform">Fraud Detection</a>
                </li>
                <li>
                  <a href="#platform">Case Management</a>
                </li>
              </ul>
            </div>
            <div>
          ...
          <div className="mt-10 text-xs text-muted-foreground">
            © {new Date().getFullYear()} Aegis Intelligence. All rights
            reserved.
          </div>
        </Section>
      </footer>
